...
const Protocol = {
  ...
  async hello(ctx) {
    console.log(parseRuleID(111843999800));
    DBClient.query('SELECT * FROM data_dict_daily_pass_rate')
      .then(([res]) => {
        for (const obj of res) {
          console.log(typeof obj.pass_rate.succ_rate);
          console.log(obj.pass_rate.succ_rate);
        }
      });
  },
